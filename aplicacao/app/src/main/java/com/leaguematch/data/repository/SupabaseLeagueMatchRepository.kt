...
class SupabaseLeagueMatchRepository(
    ...
    override suspend fun atualizarJogo(
        ...
        atualizarJogoInterno(id, resultadoCasa, resultadoFora, estado, local, data, hora, atualizarInicio = false)
    ...
    override suspend fun guardarEstatisticasJogo(
        ...
        return withContext(Dispatchers.IO) {
            deleteWhere(
                ...
                filters = mapOf("partida_id" to "eq.$partidaId")
            )
    ...
    override suspend fun removerJogadorEquipa(equipaId: Int, utilizadorId: Int): Boolean {
        return withContext(Dispatchers.IO) {
            runCatching {
                deleteWhere(
                    "team_member",
